...
import {TGPageHome} from "../TGPageHome/index";
import {TGPageProjects} from "../TGPageProjects/index";
import {TGPageMiscPages} from "../TGPageMiscPages/index";
...
export class AdminPage extends React.Component {
  ...
  renderLeftMenu() {
    if (!this.showLeftMenu()) return null;

    return (
      <LeftMenu
        plugins={this.retrievePlugins()}
        layout={this.props.adminPage.layout}
        version={this.props.adminPage.strapiVersion}
  ...
  render() {
    ...
    return (
      <div className={styles.adminPage}>
        ...
        {this.renderLeftMenu()}
        <CTAWrapper>
          <TGHeader leftMenuToggle_onClick={this.leftMenuToggle_onClick}/>
          {this.shouldDisplayLogout() && <Logout/>}
          <LocaleToggle isLogged={this.shouldDisplayLogout() === true}/>
        </CTAWrapper>
        <div className={[styles.adminPageRightWrapper, this.state.leftMenuOpen ? styles.adminPageRightWrapper__leftMenu__isOpen : ''].join(' ')} style={style}>
          {header}
          <Content {...this.props} showLeftMenu={this.showLeftMenu()}>
            <Switch>
              {/*<Route path="/" component={HomePage} exact/>*/}
              <Route path="/" component={TGPageHome} exact/>
              <Route path="/projects" component={TGPageProjects} exact/>
              <Route path="/misc-pages" component={TGPageMiscPages} exact/>
